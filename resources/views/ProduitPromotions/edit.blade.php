        ...
        <div class="back">
            <div class="card-body">
                <div class="container-form">
                    <form id="signUpForm" method="POST" action="{{route('promotion.update',['produit' => $produit->id]) }}" class="form">
                        @csrf
                        <input id="id" type="hidden" value="{{ $produit->id }}" name="id" />
                        <!-- start step indicators -->
                        <div class="form-header mb-4">
                            <span class="stepIndicator">Editer un produit (Promotion)</span>
                        ...
                        <!-- step one -->
                        <div class="step">
                            <p class="text-center mb-4">Informations sur le produit (Promotion)</p>
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="number" min="5" required="true" style="border-radius: 10px;"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label for="prix" class="form-label">Nombre</label>
                                    <input type="number" min="5" required="true" style="border-radius: 10px;"
                                    id="nombre" name="nombre" value="{{ $produit->nombre }}" required>
                                </div>
