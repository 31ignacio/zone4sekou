    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12 mt-4">
            ...
            <a href="{{ route ('promotion.create')}}" class="btn  bg-gradient-success">Ajouter</a><br><br>
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Liste des produits en promotions</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn-sm btn-warning" href="{{ route('promotion.edit', $produit->id) }}"><i class="fas fa-edit"></i></a>
                ...
                <tr>
                    <td class="cell" colspan="5">Aucun produit ajoutés</td>
